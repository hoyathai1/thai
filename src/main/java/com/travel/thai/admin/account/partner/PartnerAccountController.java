package com.travel.thai.admin.account.partner;
...
@Controller
@RequestMapping("/admin/account/partner")
public class PartnerAccountController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response, Model model, @ModelAttribute("search") Search search, @AuthenticationPrincipal User user) {
        ...
        return "/admin/account/partner/list";
    }
