...
function search(page) {
    ...
    if (!isEmpty(content)) {
        location.href="/admin/account/partner/list?page=" + page + "&content="+content;
    } else {
        location.href="/admin/account/partner/list?page=" + page;
    }
}
...
function restoreUser() {
    ...
    $.ajax({
        type : 'post',
        url : '/admin/account/partner/restoreUser',
        headers : {
            "Content-Type" : "application/json",
            "X-HTTP-Method-Override" : "POST"
        },
...
function modifyEmail() {
    ...
    $.ajax({
        type : 'post',
        url : '/admin/account/partner/modifyEmail',
        headers : {
            "Content-Type" : "application/json",
            "X-HTTP-Method-Override" : "POST"
        },
...
function registerAdmin() {
    ...
    $.ajax({
        type : 'post',
        url : '/admin/account/partner/register',
        headers : {
            "Content-Type" : "application/json",
            "X-HTTP-Method-Override" : "POST"
        },
...
function modifyPwd() {
    ...
    $.ajax({
        type : 'post',
        url : '/admin/account/partner/modifyPwd',
        headers : {
            "Content-Type" : "application/json",
            "X-HTTP-Method-Override" : "POST"
        },
