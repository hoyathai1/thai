...
function search(page) {
    ...
    if (!isEmpty(content)) {
        location.href="/admin/banner/board?pageNum=" + page + "&content="+content;
    } else {
        location.href="/admin/banner/board?pageNum=" + page;
    }
}
...
function btnRegister() {
    ...
    $.ajax({
        type : 'post',
        url : '/admin/banner/board/register',
        headers : {
