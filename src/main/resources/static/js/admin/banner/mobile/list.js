...
function imgRegister(device, position) {
    ...
    $.ajax({
        ...
        success : function () {
            location.href = "/admin/banner/mobile?category=" + category;
        },
        beforeSend : function () {
...
function goView1() {
    var category = $("#category").val();
    window.open("/admin/banner/mobile/view1?category=" + category);
}

function goView2() {
    var category = $("#category").val();
    window.open("/admin/banner/mobile/view2?category=" + category);
}
