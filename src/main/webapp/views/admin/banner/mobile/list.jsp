...
<body class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">리스트 배너 (400px x 75px)</h3>
                            </div>

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="topBannerLink">리스트 링크 주소</label>
                            ...
                            <div class="card-footer">
                                <c:if test="${dto.topBanner.show eq true}">
                                    <button type="submit" class="btn btn-danger" onclick="hiddenBanner('MOBILE', 'TOP')">비활성화</button>
                                </c:if>
                                <c:if test="${dto.topBanner.show eq false}">
                                    <button type="submit" class="btn btn-primary" onclick="showBanner('MOBILE', 'TOP')">활성화</button>
                                </c:if>
                                <button type="submit" class="btn btn-primary" onclick="bannerBtn('MOBILE', 'TOP')">저장</button>
                            </div>
                        </div>
                    </div>  <%--.col-6--%>
                    <div class="col-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">하단 배너 (400px x 75px)</h3>
                            </div>

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="bottomBannerLink">하단 링크 주소</label>
                            ...
                            <div class="card-footer">
                                <c:if test="${dto.bottomBanner.show eq true}">
                                    <button type="submit" class="btn btn-danger" onclick="hiddenBanner('MOBILE', 'BOTTOM')">비활성화</button>
                                </c:if>
                                <c:if test="${dto.bottomBanner.show eq false}">
                                    <button type="submit" class="btn btn-primary" onclick="showBanner('MOBILE', 'BOTTOM')">활성화</button>
                                </c:if>
                                <button type="submit" class="btn btn-primary" onclick="bannerBtn('MOBILE', 'BOTTOM')">저장</button>
                            </div>
                        </div>
                    </div>  <%--.col-6--%>
                    <div class="col-6">
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">댓글 배너 (400px x 75px)</h3>
                            </div>

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="leftBannerLink">댓글배너 링크 주소</label>
                            ...
                            <div class="card-footer">
                                <c:if test="${dto.leftBanner.show eq true}">
                                    <button type="submit" class="btn btn-danger" onclick="hiddenBanner('MOBILE', 'LEFT')">비활성화</button>
                                </c:if>
                                <c:if test="${dto.leftBanner.show eq false}">
                                    <button type="submit" class="btn btn-primary" onclick="showBanner('MOBILE', 'LEFT')">활성화</button>
                                </c:if>
                                <button type="submit" class="btn btn-primary" onclick="bannerBtn('MOBILE', 'LEFT')">저장</button>
                            </div>
                        </div>
                    </div>  <%--.col-6--%>
                    <div class="col-6">
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">상세 리스트 배너 (400px x 75px)</h3>
                            </div>

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="rightBannerLink">상세 리스트 링크 주소</label>
                            ...
                            <div class="card-footer">
                                <c:if test="${dto.rightBanner.show eq true}">
                                    <button type="submit" class="btn btn-danger" onclick="hiddenBanner('MOBILE', 'RIGHT')">비활성화</button>
                                </c:if>
                                <c:if test="${dto.rightBanner.show eq false}">
                                    <button type="submit" class="btn btn-primary" onclick="showBanner('MOBILE', 'RIGHT')">활성화</button>
                                </c:if>
                                <button type="submit" class="btn btn-primary" onclick="bannerBtn('MOBILE', 'RIGHT')">저장</button>
                            </div>
                        </div>
                    </div>  <%--.col-6--%>
                </div>
                <div class="row">
                    <div class="col-12">
                        <button type="button" class="btn btn btn-info float-right" onclick="goView2()">
                            상세 미리보기
                        </button>
                        <button type="button" class="btn btn btn-info float-right" onclick="goView1()" style="margin-right: 5px">
                            리스트 미리보기
                        </button>
    ...
    <script type="text/javascript" src="/js/admin/banner/mobile/list.js"></script>
</body>
</html>