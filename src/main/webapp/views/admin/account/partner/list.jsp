...
<body class="wrapper">
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">파트너 관리</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                                    ...
                                    <c:forEach items="${list.content}" var="user">
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${user.del eq false}">
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn btn-primary" onclick="modifyPwdModal('${user.userId}')">
                                                        변경
                                                    </button>
                                                </td>
                                            </c:if>
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="button" class="btn btn btn-info float-right" onclick="registerAdminModal()">
                            파트너 추가
                        </button>
                    </div>
                </div>
    ...
    <div class="modal fade" id="register-modal" style="display: none; padding-right: 15px;" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">관리자 계정 생성</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeModal()">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="admin_id" class="col-sm-2 col-form-label">아이디</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="admin_id" placeholder="아이디 입력">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="admin_pwd" class="col-sm-2 col-form-label">비밀번호</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="admin_pwd" placeholder="비밀번호 입력">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="admin_name" class="col-sm-2 col-form-label">닉네임</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="admin_name" placeholder="닉네임 입력">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="admin_email" class="col-sm-2 col-form-label">이메일</label>
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="admin_email" placeholder="이메일 입력">
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal" onclick="closeModal()">Close</button>
                    <button type="button" class="btn btn-primary" onclick="registerAdmin()">등록</button>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="pwdModify-modal" style="display: none; padding-right: 15px;" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="modify-pwd" class="col-sm-2 col-form-label">비밀번호</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="modify-pwd" placeholder="비밀번호 입력">
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal" onclick="closeModal()">Close</button>
                    <button type="button" class="btn btn-primary" onclick="modifyPwd()">변경</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript" src="/js/admin/account/partner/list.js"></script>
</body>
</html>