...
<body class="wrapper">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <c:forEach items="${list.content}" var="inform">
                                        ...
                                        <tr onclick="viewModal(${inform.id})">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="category">
                        ...
                        <label>타입</label>
                        <select class="type-select" name="b-type" id="boardType">
                        </select>
                    </div>
                    <div class="title">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="category">
                        ...
                        <label>타입</label>
                        <select class="type-select" name="b-type" >
                        </select>
                    </div>
                    <div class="title">
    ...
    <script type="text/javascript" src="/js/admin/board/board/inform.js"></script>
