                    ...
                    <c:if test="${not empty list.content}">
                        <c:forEach items="${list.content}" var="comment">
                            ...
                            <div class="comment" onclick="goComment('${comment.id}', '${comment.boardId}', '${comment.category}')">
                                ...
                                <div class="moveBtn"><button onclick="goComment('${comment.id}', '${comment.boardId}', '${comment.category}')">이동</button></div>
...
<script type="text/javascript" src="/js/common/m.myComment.js"></script>
